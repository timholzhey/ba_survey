...
def get_question_groups() -> list[list]:
    return [
        ...
        [100, 200, "1 Monat", "", "Möchten Sie lieber in {0} {1} € zahlen oder {2} € jetzt?", "{1} € jetzt", "{2} € in {0}", "Entscheiden Sie sich zwischen dem Betrag, den Sie <b>jetzt zahlen</b> müssen, oder {2} € die Sie <b>in {0} zahlen</b> müssen.", "survey_delay_info"],
