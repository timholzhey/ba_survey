...
def get_question_groups() -> list[list]:
    return [
        ...
        [100, 200, "95 %", "5 %", "Möchten Sie lieber {2} € mit Sicherheit zahlen oder {1} € mit einer Wahrscheinlichkeit von {0}?", "{1} € mit Sicherheit", "{2} € zu {0}", "Entscheiden Sie sich zwischen dem Betrag, den Sie <b>mit Sicherheit zahlen</b> müssen, oder {2} € die Sie <b>mit einer Wahrscheinlichkeit von {0} zahlen</b> müssen (d.h. zu {3} müssen Sie nichts zahlen).", "survey_delay_info"],
